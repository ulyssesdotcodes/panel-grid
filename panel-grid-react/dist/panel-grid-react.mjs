...
var PanelGridContext = createContext({
...
var Panel = ({
  ...
  return resizeBar ? /* @__PURE__ */ React.createElement(
    "div",
    {
      ref: wrapperRef,
      style: {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      collapsedSize && resizeBar.position === "right" && /* @__PURE__ */ React.createElement(
        "div",
        {
          ref: iconRef,
      ...
      (!isMinimized || resizeBar?.position === "top" || resizeBar?.position === "bottom") && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            flexGrow: 1,
...
var PanelGrid = ({ gridTemplateAreas, initialTemplates, resizeBars, children, style }) => {
  ...
  const [templateSizes, setTemplateSizes] = useLocalStorage(
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { height: "100%", width: "100%" } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      ref: gridRef,
  ...
  ), /* @__PURE__ */ React.createElement("div", null, resizeBars.filter(
  ...
  ).map((props) => /* @__PURE__ */ React.createElement(
    ResizeBarElement,
    {
      ...props,
...
//# sourceMappingURL=panel-grid-react.mjs.map